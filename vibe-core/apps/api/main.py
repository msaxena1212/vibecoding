...
# Porting Note: Frontend is now served by Vibe-UI (React) on port 5173
# The Python API now exclusively handles agentic orchestration.

@app.get("/")
async def root():
    return {"message": "Vibe-Core API is operational. Use the React UI on port 5173."}
