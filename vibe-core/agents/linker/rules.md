...
- **CTA Verification**: Explicitly check that high-visibility CTAs (Buttons) on the homepage lead to existing, relevant sub-pages. If a button's target is missing, the Linker MUST flag this or create the necessary link.
